...
const navItems = [
    { icon: 'dashboard', label: 'Dashboard', page: 'staff-dashboard' },
    { icon: 'history', label: 'Riwayat', page: 'staff-history' },
    { icon: 'description', label: 'Laporan', page: 'staff-reports' },
    { icon: 'settings', label: 'Pengaturan', page: 'staff-settings' },
]

function StaffSidebar({ currentPage, onNavigate }) {
        ...
        <div className="hidden w-64 flex-col border-r border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 md:flex">
            ...
            <div className="p-6">
                <div className="flex flex-col">
                    ...
                    <p className="text-slate-500 dark:text-slate-400 text-sm font-normal leading-normal">Staff Panel</p>
                </div>
            </div>
